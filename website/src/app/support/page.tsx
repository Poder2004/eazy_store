    ...
    items: [
      {
        ...
        a: "สแกน QR Code เพื่อดาวน์โหลดไฟล์ APK แล้วติดตั้งแอป จากนั้นกดสมัครสมาชิก กรอกชื่อ อีเมล และรหัสผ่าน ยืนยันอีเมล แล้วเข้าสู่ระบบได้เลย",
      },
      {
    ...
    items: [
      {
        ...
        a: "ไปที่เมนูเพิ่มสินค้า กรอกชื่อสินค้า ราคา และสต็อก ฯลฯ แล้วกดบันทึก",
      },
      {
    ...
    items: [
      {
        ...
        a: "ในหน้าเข้าสู่ระบบ กด 'ลืมรหัสผ่าน' กรอกอีเมลที่ลงทะเบียนไว้ ระบบจะส่ง รหัส OTP ไปที่อีเมล และนำOTP ที่ได้มากรอกเพื่อ รีเซ็ตรหัสผ่านใหม่ ",
      },
      {
        q: "เปลี่ยนอีเมลบัญชีได้ไหม?",
        a: "เปลี่ยนที่หน้าโปรไฟล์และ เลือกแก้ไขข้อมูลส่วนตัว กรอกอีเมลใหม่ ระบบจะส่ง รหัส OTP ไปที่อีเมล และนำOTP ที่ได้ มากรอกเพื่อยืนยันการเปลี่ยนแปลง",
      },
    ],
  },
];
